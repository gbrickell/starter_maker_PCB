# starter maker kit PCB version of LED_flash.py that flashes a single LED on/off

# command to run this script:  python3 /home/pi/starter_maker_kit1/RPi_code/starter_ebasics/LED_flash.py
