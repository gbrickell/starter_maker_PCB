# starter maker kit PCB version of LED_red_green_flash.py that alternates on/off for two LEDs (red & green)

# command to run this script:  python3 /home/pi/starter_maker_kit1/RPi_code/starter_ebasics/LED_red_green_flash.py
