...
# Starter Kit PCB image streaming Flash app
...
# command to run: sudo python3 /home/pi/starter_maker_kit1/RPi_code/image_taking/image_taking_controller/image_streaming_app_root_annotate.py
