...
#
# command: python3 ./starter_maker_kit1/RPi_code/image_taking/timelapse_cron_take_image.py
#
...
#*/5 * * * * python3 ./RPi_maker_kit5/image_taking/timelapse_cron_take_image.py >> /dev/null 2>> /dev/null
